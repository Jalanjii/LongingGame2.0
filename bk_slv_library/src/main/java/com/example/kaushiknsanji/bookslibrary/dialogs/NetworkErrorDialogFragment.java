...
public class NetworkErrorDialogFragment extends DialogFragment
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == R.id.network_error_settings_btn_id) {//When the Positive Button is clicked
        ...
        } else if (id == R.id.network_error_cancel_btn_id) {//When the Negative Button is clicked
