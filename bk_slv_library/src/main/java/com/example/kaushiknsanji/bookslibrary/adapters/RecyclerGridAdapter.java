 ...
 * that is used along with the {@link StaggeredGridLayoutManager}
...
public class RecyclerGridAdapter extends RecyclerView.Adapter<RecyclerGridAdapter.ViewHolder>
    ...
    public Loader<DiffUtil.DiffResult> onCreateLoader(int id, Bundle args) {
        if (id == BooksDiffLoader.BOOK_DIFF_LOADER) {//Preparing the Diff Loader and returning the instance
    ...
    public void onLoadFinished(@NonNull Loader<DiffUtil.DiffResult> loader, DiffUtil.DiffResult diffResult) {
        if (diffResult != null) {
            ...
            if (loader.getId() == BooksDiffLoader.BOOK_DIFF_LOADER) {//Update the New Data to the Adapter and notify the changes in the data
