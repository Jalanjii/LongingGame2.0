...
public class PaginationNumberPickerDialogFragment extends DialogFragment
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == R.id.page_number_picker_set_btn_id) {//When the Positive button is clicked
        ...
        } else if (id == R.id.page_number_picker_cancel_btn_id) {//When the Negative button is clicked
