...
public class BookDetailActivity extends AppCompatActivity
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == R.id.detail_epub_button_id) {//For the EPUB Preview Button
            openLink(mEpubLink);
        } else if (id == R.id.detail_pdf_button_id) {//For the PDF Preview Button
            openLink(mPdfLink);
        } else if (id == R.id.detail_web_button_id) {//For the WEB Preview Button
            openLink(mPreviewLink);
        } else if (id == R.id.detail_info_button_id) {//For the Info Button
            openLink(mInfoLink);
        } else if (id == R.id.detail_buy_button_id) {//For the Buy Button
            openLink(mBuyLink);
        } else if (id == R.id.detail_book_image_id) {//For the Book Image shown
        ...
        } else if (id == R.id.detail_title_text_id) {//For the Title TextView
        ...
        } else if (id == R.id.detail_author_text_id) {//For the Author TextView
    ...
    private void addExpandableStateForEllipsizedTextViews(TextView textView) {
        ...
        if (totalLineCount > 0) {
            ...
            if (totalEllipseCount > 0) {
                ...
                if (id == R.id.detail_title_text_id) {//For the Title TextView
                ...
                } else if (id == R.id.detail_author_text_id) {
